...
import com.ace.mobile.core.database.dao.BlockDao
...
import com.ace.mobile.feature.ranking.data.RankingCacheRepository  // ← NUEVO
    ...
    private suspend fun resolveResponse(
        ...
        when (response.code()) {
            201 -> {
                ...
                // ← NUEVO: Invalidar cache de ranking si el backend indica cambio
                if (body.rankChanged) {
