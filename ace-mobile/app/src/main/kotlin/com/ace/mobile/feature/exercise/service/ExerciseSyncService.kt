package com.ace.mobile.feature.exercise.service
...
import com.ace.mobile.feature.exercise.service.worker.SyncBlockWorker
...
class ExerciseSyncService : Service() {
    ...
    @Inject
    lateinit var blockRepository: com.ace.mobile.core.data.BlockRepository
